  ...
  return (
    <div className='relative w-[100vw] h-[60vh] md:h-[87vh] bg'>
        <div className='w-[80%] mx-auto h-[100%] flex flex-col items-start justify-center'>
            ...
            we're your gaming sanctuary. With an expansive collection, unbeatable prices, and a 
            commitment to customer satisfaction, we redefine what it means to shop for games. 
            Experience the joy of exploring our meticulously curated selection, where every title 
            is a gem waiting to be discovered. Elevate your gaming journey with us – 
            because when it comes to buying games, we're the unrivaled champions. Welcome to the 
            ...
            <div>
                ...
                before:bg-rose-700 before:transition-all before:duration-300 hover:text-white hover:shadow-black
